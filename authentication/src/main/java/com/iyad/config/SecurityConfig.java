package com.iyad.config;

import com.iyad.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(UserService userDetailsService, JwtTokenProvider tokenProvider) {
